...
//
// import static
// http.constants.CloudWorkerRestApiConstants.CLOUD_WORKER_REST_PATH;
...
//
// private final DefaultUriComponentsBuilderFactory
// defaultUriComponentsBuilderFactory;
//
// private final FileContentFactory fileContentFactory;
//
// @Option(name = { "-f", "--file" }, description = "Location to a file for
// upload")
// private File file;
//
// @Option(name = { "-d", "--destination" }, description = "Destination for the
// uploaded file")
...
// .pathSegment(CLOUD_WORKER_REST_PATH, UPLOAD_FILE_PATH,
// getDestination()).build();
